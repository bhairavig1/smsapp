...
<body>
	...
	<h6 class="p-3 text-primary "> <u>Instalment Details :-</u> </h6> 
	 ...
	 <table class="table table-hover border border-secondary "> 
	 	<tbody> 
	 		<tr class="table-primary fs-6"> 
	 			<th>Student Id</th> 
	 			<td>${money.studentId}</td> 
	 			</tr> 
	 			
	 			<tr class="table-primary fs-6"> 
	 			<th>Student Name</th> 
	 			<td>${money.studentFullName}</td> 
	 			</tr> 
	 			
	 			<tr class="table-primary fs-6"> 
	 			<th>Course Name</th> 
	 			<td>${money.studentCourse}</td> 
	 			</tr> 
	 			
	 			<tr class="table-primary fs-6"> 
	 			<th>Batch Number</th> 
	 			<td>${money.batchNumber}</td> 
	 			</tr> 
	 			
	 			<tr class="table-danger fs-6"> 
	 			<th>Fees Paid</th> 
	 			<td>${money.feesPaid}</td> 
	 			</tr> 
